	        ...
	        <div class="filter-container">
				...
				<div class="detailed-filter-bar">
		            ...
		            <div class="filter-group dropdown">
					    <button type="button" class="btn-filter" onclick="toggleDropdown('tagBox', event)">성격 ▼</button>
		            ...
		            <%-- 크기 --%>
		            <div class="filter-group dropdown">
					    <button type="button" class="btn-filter" onclick="toggleDropdown('sizeBox', event)"> 크기 ▼</button>
		            ...
		            <%-- 성별 --%>
		            <div class="filter-group dropdown">
					    <button type="button" class="btn-filter" onclick="toggleDropdown('genderBox', event)">성별 ▼</button>
