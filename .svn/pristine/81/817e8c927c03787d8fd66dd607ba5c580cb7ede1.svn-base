...
@WebServlet("/admin/report/animal.do")
public class AdminAnimalReportProcessController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            // action을 processYn으로 매핑
            // Y = 처리완료, R = 기각 (DB에 저장)
            boolean result = service.updateAnimalReportProcess(reportId, action);
